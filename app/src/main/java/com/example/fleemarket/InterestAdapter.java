...
public class InterestAdapter extends RecyclerView.Adapter<InterestAdapter.ItemViewHolder> {
    ArrayList<InterestData> dataList = new ArrayList<>();
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_interest_item_list,parent,false);
    ...
    public void addItem(InterestData data) {
        dataList.add(data);
    }
